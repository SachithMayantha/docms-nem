<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%><!-- page header -->
<!doctype html>
...
<head>
    ...
    <!-- mCustomScrollbar CSS
		============================================ -->
    <link rel="stylesheet" href="http://192.243.108.248/mms/assets/new/css/scrollbar/jquery.mCustomScrollbar.min.css" type="text/css">
    <!-- metisMenu CSS
		============================================ -->
    <link rel="stylesheet" href="http://192.243.108.248/mms/assets/new/css/metisMenu/metisMenu.min.css" type="text/css">
    <link rel="stylesheet" href="http://192.243.108.248/mms/assets/new/css/metisMenu/metisMenu-vertical.css" type="text/css">
    <!-- calendar CSS
		============================================ -->
                ...
                <ul class="metismenu" id="menu1">
                    ...
                    <li>
                        <a href="projects.html" >
                            <img src="http://192.243.108.248/mms/assets/new/img/BodyPNG/project.png" style="height:25px;">
                    ...
                    <li>
                        <a href="main.html" style="color:#337ab7;border:outset" ></span>
                            <img src="http://192.243.108.248/mms/assets/new/img/BodyPNG/Home.png">
                                    ...
                                    <nav id="dropdown">
                                        <ul class="mobile-menu-nav">
                                            ...
                                            <ul id="demoevent" class="collapse dropdown-header-top">
                                                ...
                                                href="../User/users">Advance Payments
                                                <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demopro" class="collapse dropdown-header-top">
                                                ...
                                                href="../Vehicle/vehicles">Performance Payments
                                                <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demolibra" class="collapse dropdown-header-top">
                                                ...
                                                href="../Suppliers/supplier">Retentions
                                                <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#Tablesmob"
                                                href="../Final_report/Report">Insurance
                                                <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demoevent"
                                            href="../Location/ClearLacation">Users
                                            <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demoevent" class="collapse dropdown-header-top">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            ...
                                                            <input type="hidden" class="form-control" name="current_url"
                                                                ...
                                                                value="http://192.243.108.248/mms/index.php/Project/projects" required />
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="header-top-area" style="background-color:white">
                                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-9">
                                                ...
                                                <img src="../images/New.png"><br>Add</button></a>
                                        ...
                                        <!--Start of User button-->
                                             <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                                 <button type="button" href="#" data-toggle="dropdown" role="button"
                                                     ...
                                                     <span class="step">U</span><br></button>
                                                 <ul role="menu"
                                                     ...
                                                     <li><a href="http://192.243.108.248/mms/index.php/User/LogoutUser"><span
...
<div class="product-tab-list tab-pane fade " id="Delete1">
    ...
    <!--Delete Model Start-->
        <div id="zoomInDown4" class="modal modal-edu-general modal-zoomInDown fade" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header header-color-modal bg-color-1">
                        <h4 class="modal-title">Project</h4>
                             ...
                             <form name="bulk_action_form" action="" method="post">
                                 ...
                                 <table id="table" class="table table-striped table-bordered" style="width:100%;">
                                     ...
                                     <tbody>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  <tr>
                                             <td>CPF0456</td>
                                             <td>Akuressa-3</td>
                                             <td>Southern Highway project part</td>
                                         </tr>
                                         <td>CPL0976</td>
                                         <td>Matara-6</td>
                                         <td>Southern Highway project final part</td>
                                        </tr>
                                        <td>TPZ0900</td>
                                        <td>Marawila-2</td>
                                        <td>Chilaw-Negombo main road project</td>
                                    </tr>
                                    <td>CPL0970</td>
                                    <td>Matara-5</td>
                                    <td>Southern Highway project final part</td>
