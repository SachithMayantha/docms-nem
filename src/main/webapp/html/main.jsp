                                        ...
                                        <div class="header-top-area" style="background-color:white">
                                            ...
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                                ...
                                                <ul role="menu" class="dropdown-toggle dropdown-menu animated dropdown-menu-right zoomIn">
                                                    ...
                                                    <li><a class="zoomInDown mg-t" href="#" data-toggle="modal" data-target="#zoomInDown10"><span class="edu-icon edu-settings author-log-ic"></span>
                                                        Change Password</a>
                                                    </li>
        ...
        <div class="sparkline13-list">
            ...
            <div class="sparkline13-hd">
                <div class="main-sparkline13-hd">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <h2><br>
                            <center> <br>NEM Construction (PVT) Ltd,<br> Welcome to Insurance & Guarantee Document<br>Management
                                System!</center>
                        </h2>
                    </div>
                </div>
