...
<link rel="stylesheet" type="text/css"
	href="/css/bootstrap-progressbar-3.3.4.css" />
<!-- Theme color -->
				...
				<div class="slide-content">
					<div class="container">
						<div class="row">
							<div class="col-md-6 col-sm-6">
								<div class="slide-article">
									<h1 class="wow fadeInUp" data-wow-duration="0.7s"
										data-wow-delay="0.5s">
										<font size="6">Welcome to the Insurance & Guarantee
											Document Management System</font>
									</h1>
									<p class="wow fadeInUp" data-wow-duration="0.7s"
										data-wow-delay="0.75s">
										Powered by NEM-ERP Engineering & Research Unit <br> <br>
										<a style="color: #ff9900; font-size: 26px"
											class="login modal-form" data-target="#login-form"
											data-toggle="modal" href="#login-form"> ENTRY </a>
							...
							<div class="col-md-6 col-sm-6">
								<div class="slider-img wow fadeInUp"></div>
							</div>
						</div>
					</div>
				</div>
