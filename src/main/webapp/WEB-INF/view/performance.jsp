				...
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"
					...
					<c:if test="${per.remain>'50'}">
						...
						<button type="button" class="btn btn-success"
							...
							onclick="myClick('${per.id}','${per.name}',
                                     '${per.amount}','${per.effective}','${per.expire}','${per.status}');">
							<c:out value="${per.name}" />
							<br>
							<c:out value="${per.amount}" />
							<br>
							<c:out value="${per.remain}" />
							&nbsp; days remaining<br>
							<c:out value="${per.status}" />
						</button>
					</c:if>
					...
					<c:if test="${per.remain<'20' && per.remain>'0'}">
