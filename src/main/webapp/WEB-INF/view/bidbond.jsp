									...
									<div class="basic-login-form-ad">
										...
										<div class="row">
											<div class="header-top-area" style="background-color: white">
                                                ...
                                                <img src="../images/view.png"><br>View</button>

                                                <a class="zoomInDown mg-t">
                                                    <button type="button" class="btn btn-link"
                                                        data-toggle="modal" data-target="#zoomInDown3" disabled>
                                                     <img src="../images/edit.png"><br>Edit</button></a>
                                                ...
                                                <a class="zoomInDown mg-t">
													...
													<a>
														<button type="submit" class="btn btn-link" value="Refresh"
											...
											<div id="zoomInDown1"
												...
												<div class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header header-color-modal bg-color-1">
															<h4 class="modal-title">New BidBond Document</h4>
															<div class="modal-close-area modal-close-df">
																<a class="close" data-dismiss="modal" href="#"><i
																	class="fa fa-close"></i></a>
															</div>
