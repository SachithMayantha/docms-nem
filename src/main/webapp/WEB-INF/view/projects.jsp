			...
			<nav class="sidebar-nav left-sidebar-menu-pro">
				<ul class="metismenu" id="menu1">
					...
					<li><a href="${pageContext.request.contextPath}/main"
						style="color: #337ab7; border: outset"> <img
...
$(function() {
																					...
																					<div class="row">
																						...
																						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																							<input type="text" class="form-control"
																								placeholder="Enter Project Code" name="id"
																					...
																					<div class="row">
																						...
																						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																							<div class="login-horizental">
																								<button
																									class="btn btn-sm btn-primary login-submit-cs"
																									type="submit" value="Save">Add Project</button>
																								...
																								<div class="row">
																									...
																									<div
																										...
																										<input type="hidden" class="form-control"
																											placeholder="Enter Project Code"
																											id="E_E_H_ProjectCode" name="id" /> <input
																											type="text" class="form-control"
																											placeholder="Enter Project Code"
																									...
																									<div
																										...
																										<div class="login-horizental">
																											...
																											<ul
																												...
																												style="min-width: 130px; font-size: 20px; padding: 5px;">
																												<li>
																													<center>Save the changes to the
																														Project</center>
																													<br>
																												</li>
																												<li>
																				...
																				<form method="post" action="/project/update"
																					...
																					<div class="form-group-inner">
																						<div class="row">
																							...
																							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																								<input type="hidden" class="form-control"
																									name="name" id="D_E_H_ProjectName" />
																							</div>
																						</div>
																					</div>
	...
	<div class="row">
		...
		<form name="bulk_action_form" action="/project/allProjects"
			method="GET">
			...
			<table id="table" class="table table-striped table-bordered"
				...
				<tbody>
					<c:forEach var="pro" items="${listProjects}">
						<tr>
						<tr>
