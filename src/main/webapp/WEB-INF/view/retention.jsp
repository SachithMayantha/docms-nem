            ...
            <ul class="metismenu" id="menu1">
                ...
                <li><a
                        ...
                        aria-expanded="false"> <img src="../images/bidbond.png"
                                                    style="height: 25px;"> <span class="mini-click-non"
                                                                                 style='font-size: 12px;'>Bid Bonds</span></a>
                </li>
                ...
                <li><a href="${pageContext.request.contextPath}/user/allUsers"
                       aria-expanded="false"> <img src="../images/users.png"
                                                   style="height: 25px;"> <span class="mini-click-non"
                                                                                style='font-size: 12px;'>Users</span></a>
                </li>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                    <div class="basic-login-inner modal-basic-inner">
                                                                        ...
                                                                        <form method="POST"
                                                                              action="/retention/addRetention"
                                                                              class="projectAdd">

                                                                            <div class="form-group-inner">
                                                                                <div class="row">
                                                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                                        <label class="login2">Document
                                                                                            ID</label>
                                                                                    </div>
                                                                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                                                        <input type="text"
