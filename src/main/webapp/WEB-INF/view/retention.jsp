								...
								<div class="mobile-menu">
									<nav id="dropdown">
										<ul class="mobile-menu-nav">
											...
											<li><a href="#" aria-expanded="false"> <img
													src="../images/insurance.png" style="height: 25px;">
...
$(function() {
																...
																<div class="row">
																	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																		<div class="basic-login-inner modal-basic-inner">
																			...
																			<form method="POST" action="/retention/addRetention"
																				class="projectAdd">
	...
	<!-- End modal -->
	<div class="row">
		<form name="bulk_action_form" action="/retention/allRetention"
			method="GET">
				...
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"
					...
					<c:if test="${ret.remain>'50'}">
						...
						<button type="button" class="btn btn-success"
							...
							onclick="myClick('${ret.id}','${ret.name}',
                                     '${ret.amount}','${ret.effective}','${ret.expire}','${ret.status}');">
							<c:out value="${ret.name}" />
							<br>
							<c:out value="${ret.amount}" />
							<br>
							<c:out value="${ret.remain}" />
							&nbsp; days remaining<br>
							<c:out value="${ret.status}" />
						</button>
					</c:if>
					...
					<c:if test="${ret.remain<'20' && ret.remain>'0'}">
