                ...
                <div class="row">
                    ...
                    <div class="form-group-inner">
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                <input type="text" class="form-control" name="id" id="V_V_ProjectCode"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group-inner">
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                <input type="text" class="form-control" name="userName" id="V_V_ProjectName" />
                            </div>
                        </div>
                    </div>
                    <div class="login-btn-inner">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="review-content-section">
                <div class="row">
                    ...
                    <form method="post" action="/user/update" class="project_Edit">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="review-content-section">
                <div class="row">
                    ...
                    <form action="/user/delete" method="post" accept-charset="utf-8">
                    ...
                    <div class="form-group-inner">
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                ...
                                <input type="hidden" class="form-control" name="username" id="V_D_H_ProjectName" required/>
                            </div>
                        </div>
                    </div>
                    </div>
...
<!--Edit Model Start-->
                 ...
                 <div class="product-tab-list tab-pane fade" id="View1">
                        ...
                        <form method="post" action="/user/update" class="userAdd">
                            <div class="review-content-section">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                        <input type="text" class="form-control" name="id" id="E_V_ProjectCode"/>
                                    </div>
                                </div>
                        </div>
                    ...
                    <div class="form-group-inner">
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                <input type="text" class="form-control" name="username" id="E_V_ProjectName"/>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="review-content-section">
                <div class="row">
                    <form method="post" action="/user/update" class="projectE_Edit">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="review-content-section">
                <div class="row">
                    ...
                    <form method="post" action="/user/update" class="projectD_Edit">
