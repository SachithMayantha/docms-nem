														...
														<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
															<div class="login-horizental">
																...
																<ul
																	...
																	<li>Are You sure to change the password? <br>
																	</li>
																					...
																					<div class="row">
																						...
																						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																							<input type="text" class="form-control"
																								placeholder="Enter User ID" name="id"
																					...
																					<div class="row">
																						...
																						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																							<div class="login-horizental">
																								<button
																									class="btn btn-sm btn-primary login-submit-cs"
																									type="submit" value="Save">Add User</button>
																											...
																											<div class="form-group-inner">
																												<div class="row">
																													...
																													<div
																														class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																														<input type="text" class="form-control"
																															name="id" id="V_D_ProjectCode" readonly />
																													</div>
																												</div>
																											</div>
																												...
																												<div class="row">
																													...
																													<div
																														...
																														<input type="text" class="form-control"
																															...
																															name="username" id="V_D_H_ProjectName"
																															required />
																													</div>
																												</div>
																											</div>
																										...
																										<div class="form-group-inner">
																											<div class="row">
																												...
																												<div
																													class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																													<input type="text" class="form-control"
																														name="username" id="E_V_ProjectName" />
																												</div>
																											</div>
																										</div>
																										...
																										<div class="form-group-inner">
																											<div class="row">
																												...
																												<div
																													class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																													<input type="hidden" class="form-control"
																														name="username" id="E_E_ProjectName" />
																												</div>
																											</div>
																										</div>
																												...
																												<div
																													...
																													<div class="login-horizental">
																														...
																														<ul
																															...
																															role="menu"
																															style="min-width: 130px; font-size: 20px; padding: 5px;">
																															<li>Save the changes to the User <br>
																															</li>
																															<li>
																																<button type="submit"
																																	class="btn btn-sm btn-primary login-submit-cs"
																						...
																						<div class="form-group-inner">
																							<div class="row">
																								...
																								<div
																									class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																									<input type="text" class="form-control"
																										name="id" id="E_D_ProjectCode" readonly />
																								</div>
																							</div>
																						</div>
																							...
																							<div class="row">
																								...
																								<div
																									...
																									<input type="text" class="form-control"
																										...
																										type="hidden" class="form-control"
																										name="username" id="E_D_H_ProjectName"
																										required />
																								</div>
																							</div>
																						</div>
										...
										<div class="container-fluid">
											<div class="row">
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													<div class="product-payment-inner-st">
														<ul id="myTabedu1" class="tab-review-design">
															<li><a href="#View2"> <i class="fas fa-search"></i>Delete
															</a></li>
															<li></li>
															<li class="active"></li>
														</ul>
																				...
																				<div class="row">
																					...
																					<div class="form-group-inner">
																						<div class="row">
																							...
																							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																								<input type="text" class="form-control"
																									name="id" id="D_V_ProjectCode" readonly />
																							</div>
																						</div>
																					</div>
																				...
																				<form method="post" action="/user/update"
																					...
																					<div class="form-group-inner">
																						<div class="row">
																							...
																							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																								<input type="hidden" class="form-control"
																									placeholder="Enter User ID"
																									id="D_E_H_ProjectCode" name="id" /> <input
																									type="text" class="form-control"
																									placeholder="Enter User ID"
																					...
																					<div class="form-group-inner">
																						<div class="row">
																							...
																							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																								<input type="hidden" class="form-control"
																									name="username" id="D_E_H_ProjectName" />
																							</div>
																						</div>
																					</div>
																							...
																							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																								<div class="login-horizental">
																									...
																									<ul
																										...
																										role="menu"
																										style="min-width: 130px; font-size: 20px; padding: 5px;">
																										<li>Save the changes to the User<br></li>
																										<li>
																											<button type="submit"
																												class="btn btn-sm btn-primary login-submit-cs"
																												id="btnSubmit">Yes</button>
