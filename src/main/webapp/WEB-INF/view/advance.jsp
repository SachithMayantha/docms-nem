								...
								<div class="mobile-menu">
									<nav id="dropdown">
										<ul class="mobile-menu-nav">
											...
											<li><a href="insurance.html" aria-expanded="false">
													<img src="../images/insurance.png" style="height: 25px;">
													<span class="mini-click-non" style='font-size: 12px;'>Insurance</span>
											</a></li>

											<li><a
												href="${pageContext.request.contextPath}/user/allUsers"
												aria-expanded="false"> <img src="../images/users.png"
													style="height: 25px;"> <span class="mini-click-non"
													style='font-size: 12px;'>Users</span></a></li>
											...
											<li><a href="${pageContext.request.contextPath}/main"
												style="color: #337ab7; border: outset"></span> <img
													src="../images/Home.png"> <span
													class="mini-click-non" style='font-size: 12px;'>Home</span></a>
											</li>
											<li><br></li>
										...
										<div class="row">
												...
												<div class="col-lg-10 col-md-10 col-sm-10 col-xs-9">
													...
													<a class="zoomInDown mg-t">
														<button type="button" class="btn btn-link" href="#"
															...
															<img src="../images/New.png"><br>Add
														</button>
													</a> <a class="zoomInDown mg-t">
														<button type="button" class="btn btn-link" href="#"
															data-toggle="modal" data-target="#zoomInDown2" disabled>
															<img src="../images/view.png"><br>View
														</button> <a class="zoomInDown mg-t">
															<button type="button" class="btn btn-link" href="#"
																data-toggle="modal" data-target="#zoomInDown3" disabled>
																<img src="../images/edit.png"><br>Edit
															</button>
													</a> <a class="zoomInDown mg-t">
															<button type="button" class="btn btn-link" href="#"
																data-toggle="modal" data-target="#zoomInDown2" disabled>
																<img src="../images/delete.png"><br> Delete
															</button>
													</a> <a>
															<button type="submit" class="btn btn-link"
																value="Refresh" onclick="history.go(0)">
																<img src="../images/Refresh.png"> <br>Refresh
															</button>
													</a>
												</div>
												<!--End of Top model-->
											...
											<div id="zoomInDown1"
												...
												<div class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header header-color-modal bg-color-1">
															<h4 class="modal-title">New Advance Payment Document</h4>
															<div class="modal-close-area modal-close-df">
																<a class="close" data-dismiss="modal" href="#"><i
																	class="fa fa-close"></i></a>
															</div>
																...
																<div class="row">
																	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																		<div class="basic-login-inner modal-basic-inner">
																			...
																			<form method="POST" action="/advance/addAdvance"
																				class="projectAdd">
																					...
																					<div class="row">
																						...
																						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																							<input type="text" class="form-control"
																								placeholder="Enter BidBond ID" name="id"
																								id="projectcode1" required />
																						</div>
																					</div>
																				</div>
																					...
																					<div class="row">
																						...
																						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																							<input type="date" class="form-control"
																								...
																								name="effective" id="projectname1" required />
																						</div>
																					</div>
																				</div>
																				<div class="form-group-inner">
																					<div class="row">
																						...
																						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																							<input type="date" class="form-control"
																								placeholder="Format should be (yyyy-MM-dd)"
																								name="expire" id="projectname1" required />
																						</div>
																					</div>
																				</div>
																				<div class="form-group-inner">
																					<div class="row">
																						...
																						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																							<input type="text" class="form-control"
																								...
																								name="status" id="projectname1" required />
																							<datalist id="status">
																								<option value="Details submitted to Bank">
																								<option
																									value="Draft copy submitted to the Beneficiary">
																								<option value="Draft verified with Beneficiary">
																								<option
																									value="Original submitted to the Beneficiary">
																								<option
																						...
																						<div
																							...
																							<div class="product-payment-inner-st">
																								<ul id="myTabedu1" class="tab-review-design">
																									<li class="active"><a href="#View"><i
																											class="fas fa-search"></i> View</a></li>
																									<li></li>
																									<li></li>
																								</ul>
																								<div id="myTabContent"
																														...
																														<div class="form-group-inner">
																															<div class="row">
																																...
																																<div
																																	class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																																	<input type="text" class="form-control"
																																		name="UserName" id="V_V_ProjectName"
																																		readonly />
																																</div>
																															</div>
																														</div>
																							...
																							<div
																								...
																								<div class="review-content-section">
																									<div class="row">
																										...
																										<form action="/bidBond/delete" method="post"
																											...
																											<div class="form-group-inner">
																												<div class="row">
																													...
																													<div
																														class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																														<input type="text" class="form-control"
																															name="ProjectCode" id="V_D_ProjectCode"
																															readonly />
																													</div>
																												</div>
																											</div>
																											...
																											<div class="form-group-inner">
																												<div class="row">
																													...
																													<div
																														class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																														<input type="text" class="form-control"
																															id="V_D_ProjectName" readonly /> <input
																															type="hidden" class="form-control"
																															name="ProjectName" id="V_D_H_ProjectName"
																															required />
																													</div>
																												</div>
																											</div>
																											...
																											<div class="form-group-inner">
																												<div class="row">
																													...
																													<div
																														class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																														<input type="text" class="form-control"
																															id="V_D_Description" name="Description"
																															readonly />
																													</div>
																												</div>
																											</div>
																													...
																													<div
																														...
																														<div class="login-horizental">
																															...
																															<ul
																																...
																																style="min-width: 130px; font-size: 20px; padding: 5px;">
																																<li>
																																	<center>Delete Project ?</center> <br>
																																</li>
																																<li>
																																	<center>
																																		<button type="submit"
												...
												<div class="container-fluid">
													<div class="row">
														<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
															<div class="product-payment-inner-st">
																<ul id="myTabedu1" class="tab-review-design">
																	<li><a href="#View1"><iclass="fasfa-search">
																			</i>View</a></li>
																	<li class="active">
																	<li>
																	<li></li>
																						...
																						<div class="form-group-inner">
																							<div class="row">
																								...
																								<div
																									class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																									<input type="text" class="form-control"
																										name="Name" id="E_V_ProjectCode" readonly />
																								</div>
																							</div>
																						</div>
																						...
																						<div class="form-group-inner">
																							<div class="row">
																								...
																								<div
																									class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																									<input type="text" class="form-control"
																										name="UserName" id="E_V_ProjectName" readonly />
																								</div>
																							</div>
																						</div>
																						...
																						<div class="form-group-inner">
																							<div class="row">
																								...
																								<div
																									class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																									<input type="text" class="form-control"
																										id="E_V_Description" name="Description"
																										readonly />
																								</div>
																							</div>
																						</div>
																	...
																	<div class="product-tab-list tab-pane fade active in"
																		...
																		<div class="row">
																			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																				<div class="review-content-section">
																					<div class="row">
																						<form method="post" action="../Project/updatedata"
																							class="projectE_Edit">
																							...
																							<div class="form-group-inner">
																								<div class="row">
																									...
																									<div
																										...
																										<input type="text" class="form-control"
																											placeholder="Enter Project Code"
																											id="E_E_ProjectCode" name="ProjectCode"
																											readonly />
																									</div>
																								</div>
																							</div>
																							...
																							<div class="form-group-inner">
																								<div class="row">
																									...
																									<div
																										class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																										<input type="text" class="form-control"
																											id="E_E_ProjectName" readonly />
																									</div>
																									<div
																										class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																										<input type="hidden" class="form-control"
																											name="ProjectName" id="E_E_H_ProjectName" />
																									</div>
																								</div>
																							</div>
															...
															<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																<div class="review-content-section">
																	<div class="row">
																		...
																		<form action="/bidBonds/delete" method="post"
																			accept-charset="utf-8">
																			...
																			<div class="form-group-inner">
																				<div class="row">
																					...
																					<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																						<input type="text" class="form-control"
																							name="ProjectCode" id="E_D_ProjectCode" readonly />
																					</div>
																				</div>
																			</div>
																			...
																			<div class="form-group-inner">
																				<div class="row">
																					...
																					<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																						<input type="text" class="form-control"
																							id="E_D_ProjectName" readonly /> <input
																							type="hidden" class="form-control"
																							name="ProjectName" id="E_D_H_ProjectName"
																							required />
																					</div>
																				</div>
																			</div>
																			...
																			<div class="form-group-inner">
																				<div class="row">
																					...
																					<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																						<input type="text" class="form-control"
																							id="E_D_Description" name="Description" readonly />
																					</div>
																				</div>
																			</div>
										...
										<div class="container-fluid">
											<div class="row">
												<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
													<div class="product-payment-inner-st">
														<ul id="myTabedu1" class="tab-review-design">
															<li><a href="#View2"> <i class="fas fa-search"></i>View
															</a></li>
															<li></li>
															<li class="active"></li>
														</ul>
														<div id="myTabContent"
															...
															<div class="product-tab-list tab-pane fade" id="View2">
																<div class="row">
																	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																		<div class="review-content-section">
																			<div class="row">
																				...
																				<div class="form-group-inner">
																					<div class="row">
																						...
																						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																							<input type="text" class="form-control"
																								name="Name" id="D_V_ProjectCode" readonly />
																						</div>
																					</div>
																				</div>
																				...
																				<div class="form-group-inner">
																					<div class="row">
																						...
																						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																							<input type="text" class="form-control"
																								name="UserName" id="D_V_ProjectName" readonly />
																						</div>
																					</div>
																				</div>
																				...
																				<div class="form-group-inner">
																					<div class="row">
																						...
																						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																							<input type="text" class="form-control"
																								id="D_V_Description" name="Description" readonly />
																						</div>
																					</div>
																				</div>
																	...
																	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
																		<div class="review-content-section">
																			<div class="row">
																				...
																				<form method="post" action="/bidBond/update"
																					class="projectD_Edit">
																					...
																					<div class="form-group-inner">
																						<div class="row">
																							...
																							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																								<input type="hidden" class="form-control"
																									placeholder="Enter Project Code"
																									id="D_E_H_ProjectCode" name="ProjectCode" /> <input
																									type="text" class="form-control"
																									placeholder="Enter Project Code"
																									id="D_E_ProjectCode" name="ProjectCode"
																									readonly />
																							</div>
																						</div>
																					</div>
																					...
																					<div class="form-group-inner">
																						<div class="row">
																							...
																							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																								<input type="text" class="form-control"
																									id="D_E_ProjectName" readonly />
																							</div>
																							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																								<input type="hidden" class="form-control"
																									name="ProjectName" id="D_E_H_ProjectName" />
																							</div>
																						</div>
																					</div>
																...
																<form action="/bidBond/delete" method="post"
																	...
																	<div class="form-group-inner">
																		<div class="row">
																			...
																			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																				<input type="text" class="form-control"
																					name="ProjectCode" id="D_D_ProjectCode" readonly />
																			</div>
																		</div>
																	</div>
																	...
																	<div class="form-group-inner">
																		<div class="row">
																			...
																			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																				<input type="text" class="form-control"
																					id="D_D_ProjectName" readonly /> <input
																					type="hidden" class="form-control"
																					name="ProjectName" id="D_D_H_ProjectName" required />
																			</div>
																		</div>
																	</div>
																	...
																	<div class="form-group-inner">
																		<div class="row">
																			...
																			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
																				<input type="text" class="form-control"
																					id="D_D_Description" name="Description" readonly />
																			</div>
																		</div>
																	</div>
	...
	<div class="row">
		<form name="bulk_action_form" action="/advance/allAdvance"
			...
			<c:forEach var="ad" items="${list}">
				...
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"
					style="padding-top: 1%;">
					<c:if test="${ad.remain>'50'}">

						<button type="button" class="btn btn-success"
							style="height: 150px; width: 300px; font-size: medium;"
							data-toggle="modal" data-target="#modalForm"
							onclick="myClick('${ad.id}','${ad.name}',
                                     '${ad.amount}','${ad.effective}','${ad.expire}','${ad.status}');">
							<c:out value="${ad.name}" />
							<br>
							<c:out value="${ad.amount}" />
							<br>
							<c:out value="${ad.remain}" />
							&nbsp; days remaining<br>
							<c:out value="${ad.status}" />
						</button>
					</c:if>

					<c:if test="${ad.remain<'50' && ad.remain>'20'}">
					...
					<c:if test="${ad.remain<'20' && ad.remain>'0'}">
								...
								<div class="basic-login-inner modal-basic-inner">
									...
									<div class="form-group-inner">
										<div class="row">
											...
											<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
												<input type="text" class="form-control" name="id" id="bidId"
													readonly />
											</div>
										</div>
									</div>
